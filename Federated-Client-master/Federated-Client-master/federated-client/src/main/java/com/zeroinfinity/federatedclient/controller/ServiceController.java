...
public class ServiceController {
	...
	@ApiOperation(value = "Pull and sync machine learning models from server", notes = "Pull and sync machine learning models from server", authorizations = {
			@Authorization(value = "jwtToken") })
	@GetMapping("/model/sync")
	public ResponseEntity<Object> syncModel() throws Exception {
		logger.info("Request received to pull and sync machine learning model from server @ V1");
	...
	@ApiOperation(value = "Pull and sync machine learning models for server", notes = "Pull and sync machine learning models for server", authorizations = {
			@Authorization(value = "jwtToken") })
	...
	public ResponseEntity<Object> syncModel(@PathVariable String modelVersion) throws Exception {
		logger.info("Request received to pull and sync machine learning model for server @ V1");
	...
	@ApiOperation(value = "Save machine learning model details", notes = "Save machine learning model details", authorizations = {
			@Authorization(value = "jwtToken") })
	@PostMapping("/model/save")
	public ResponseEntity<Object> saveModelDetail(@RequestBody SaveModelRequest request) throws Exception {
		logger.info("Request received to save model details @ V1");

		try {

			Object result = restServerService.saveModelDetail(request);
			...
			logger.error("exception - method: saveModel -> {} ", ex);
		}
